...
var FileDefs1 []genCmn.FileDefn = []genCmn.FileDefn{
	...
	{"httpServer.go.tmpl.txt",
		[]string{"pkg","httpServer"},
		"httpServer.go",
		"text",
		0644,
		"single",
	...
	{"handlers.table.go.tmpl.txt",
		[]string{"pkg","hndlr${DbName}${TblName}"},
